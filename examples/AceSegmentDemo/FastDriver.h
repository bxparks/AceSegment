...
#ifndef ACE_SEGMENT_FastDriver_H
#define ACE_SEGMENT_FastDriver_H

class FastDriver: public ace_segment::ModulatingDigitDriver {
  public:
    // Constructor
    FastDriver(ace_segment::DimmingDigit* dimmingDigits,
