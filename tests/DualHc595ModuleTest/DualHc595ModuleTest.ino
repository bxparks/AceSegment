#line 2 "DualHc595ModuleTest.ino"
...
// If the logical and physical positions are related so that they are pair-wise
// swappped, then the logical-to-physical remapArray is identical to its
// inverse.
test(DualHc595ModuleTest, invertRemapArray_self_inversion) {
...
// If the logical and physical positions are NOT pair-wise swappable, then
// the two arrays are different.
test(DualHc595ModuleTest, invertRemapArray_different_inversion) {
  const uint8_t NUM_DIGITS = 4;
